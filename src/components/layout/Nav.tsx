  ...
  return (
    <nav className="relative max-w-[1240px] mx-auto flex items-center justify-between gap-6 px-6 py-6 md:px-12 md:py-[30px]">
      ...
      <div className="flex items-center gap-4 md:gap-[38px]">
        ...
        <a
          href="#"
          className="text-sm font-medium px-4 py-[11px] md:px-[22px] rounded-full border border-cream-100/32 text-cream-100 transition-colors duration-150 hover:border-lime-400 hover:text-lime-400"
        >
          Explorar o atlas
        </a>
      </div>
